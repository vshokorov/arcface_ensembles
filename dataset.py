...
#TODO add agebd
#TODO add zip dataset
#TODO add gap in dataloader
...
def get_dataloader(
    ...
    if dali and root_dir != "synthetic":
        ...
        elif not os.path.isdir(root_dir) and \
             os.path.splitext(root_dir)[1] == '.txt':
            train_set = ListDataset(root_dir, local_rank=local_rank)
        else:
...
class ListDataset(Dataset):
    def __init__(self, ds_descr_path, local_rank, image_size=(112, 112)):
